...
/**
 *  ArrayOfAnyTypeE bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ArrayOfAnyTypeE implements org.apache.axis2.databinding.ADBBean {
    ...
    public static class Factory {
         ...
         */
        public static ArrayOfAnyTypeE parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            ArrayOfAnyTypeE object = new ArrayOfAnyTypeE();
                    ...
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "http://ws.cdyne.com/", "ArrayOfAnyType").equals(
                                    reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
                            ...
                            if ("true".equals(nillableValue) ||
                                ...
                                object.setArrayOfAnyType(ArrayOfAnyType.Factory.parse(
                                        reader));
                            }
